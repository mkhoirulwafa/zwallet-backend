...
const transfer = {
  getAllTransfer: (req, res) => {
    let { search, history } = req.query;
    if (search !== null || search !== undefined) {
      const query = `SELECT CONCAT(firstName, ' ', lastName) AS fullName, phone, avatar from users WHERE firstName LIKE '${search}%' ORDER BY firstName`;
